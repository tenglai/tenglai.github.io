            ...
            var e,
              ...
              h = function (i, c, f) {
                ...
                if (!c) {
                  var x = function () {
                      var e =
                          i.offset().top + i.outerHeight() + 5 - v.scrollTop(),
                        t = k.outerHeight();
                      i.addClass(a + "ed"),
                        g.removeClass(o),
                  ...
                  f &&
                    m.on("keyup", w).on("blur", function (t) {
                      (e = m),
                        (d = k.find("." + s).html()),
                        setTimeout(function () {
                          C(
