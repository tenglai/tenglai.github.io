!(function () {
    ...
    (i.throttle = n = function (t, n, r, o) {
      function s() {
        ...
        o && !a && i(),
          ...
          o === e && c > t
            ? i()
            : n !== !0 && (a = setTimeout(o ? s : i, o === e ? t - c : t));
      }
      var a,
        u = 0;
      return (
        "boolean" != typeof n && ((o = r), (r = n), (n = e)),
  ...
  !(function (t) {
    var e,
      ...
      c = function (t, i) {
        ...
        var r,
          ...
          d = e;
        (e = t), (n = 0);
        for (var g = 0, m = a.length; m > g; g++)
          "zIndex" in a[g] &&
            (l.push(a[g].zIndex), a[g].zIndex < 0 && (f[a[g].zIndex] = a[g]));
        for (l.sort(u); l[h] < 0; )
        ...
        for (g = 0; m > g; g++)
          if (((r = a[g]), "zIndex" in r))
            if (r.zIndex == l[h]) {
              ...
              do if ((h++, (r = f[l[h]]), r && p.push(r.apply(i, s)), n)) break;
              while (r);
            } else f[r.zIndex] = r;
    ...
    (c._events = h),
      (c.listeners = function (t) {
        ...
        for (r = 0, a = f.length; a > r; r++) {
          for (l = [], u = 0, c = d.length; c > u; u++)
            for (p = d[u].n, n = [p[f[r]], p[s]], i = 2; i--; )
              (e = n[i]), e && (l.push(e), (g = g.concat(e.f || [])));
          d = l;
        }
        return g;
      }),
      (c.on = function (t, e) {
        ...
        for (var n = t.split(o), i = h, r = 0, s = n.length; s > r; r++)
          (i = i.n),
            (i = (i.hasOwnProperty(n[r]) && i[n[r]]) || (i[n[r]] = { n: {} }));
  ...
  (function (t, e) {
    ...
    var n = (function (e) {
            ...
            for (var o in n)
              if (n.hasOwnProperty(o)) {
                ...
                if (
                  ...
                  s = [];
                  for (var h = 0, c = a.start.length; c > h; h++)
                    s[h] =
                      +a.start[h] + (a.end[h] - a.start[h]) * a.easing(a.s);
      ...
      i = (function () {
        ...
        function r(t, e) {
          if (e) {
            if (("string" == typeof t && (t = r(t)), "string" == typeof e))
              return "xlink:" == e.substring(0, 6)
                ? t.getAttributeNS(ot, e.substring(6))
                : "xml:" == e.substring(0, 4)
                ? t.getAttributeNS(st, e.substring(4))
                : t.getAttribute(e);
            for (var n in e)
              if (e[M](n)) {
                var i = j(e[n]);
                i
                  ? "xlink:" == n.substring(0, 6)
                    ? t.setAttributeNS(ot, n.substring(6), i)
                    : "xml:" == n.substring(0, 4)
                    ? t.setAttributeNS(st, n.substring(4), i)
                    : t.setAttribute(n, i)
                  : t.removeAttribute(n);
              }
        ...
        function o(t, e) {
          return (
            (e = j.prototype.toLowerCase.call(e)),
            "finite" == e
              ? isFinite(t)
              : "array" == e &&
        ...
        function f(t, e, n, i, r, o) {
          return null == e && "[object SVGMatrix]" == V.call(t)
            ? ((this.a = t.a),
              (this.b = t.b),
              (this.c = t.c),
              (this.d = t.d),
          ...
          return (
            (t = t.replace(/(?:^|\s)(\w+)\(([^)]+)\)/g, function (t, n, i) {
              return (
                ...
                "skewX" == n
                  ? e.push(["m", 1, 0, N.tan(c(i[0])), 1, 0, 0])
                  : "skewY" == n
                  ? e.push(["m", 1, N.tan(c(i[0])), 0, 1, 0, 0])
          ...
          if (n)
            for (var r = 0, o = n.length; o > r; r++) {
              ...
              "t" == d && 2 == p
                ...
                ? 2 == p
                  ? ((c = c || e),
                    i.rotate(l[1], c.x + c.width / 2, c.y + c.height / 2))
                  : 4 == p &&
                    (g
                      ? ((u = m.x(l[2], l[3])),
                        (h = m.y(l[2], l[3])),
                        i.rotate(l[1], u, h))
                      : i.rotate(l[1], l[2], l[3]))
                : "s" == d
                ? 2 == p || 3 == p
                  ? ((c = c || e),
                    i.scale(
                  ...
                  ? g
                    ? ((u = m.x(l[2], l[3])),
                      (h = m.y(l[2], l[3])),
                      i.scale(l[1], l[1], u, h))
                    : i.scale(l[1], l[1], l[2], l[3])
                  : 5 == p &&
                    (g
                      ? ((u = m.x(l[3], l[4])),
                        (h = m.y(l[3], l[4])),
                        i.scale(l[1], l[2], u, h))
                      : i.scale(l[1], l[2], l[3], l[4]))
                : "m" == d &&
                  7 == p &&
                  i.add(l[1], l[2], l[3], l[4], l[5], l[6]);
            }
          return i;
        }
        function m(t, e) {
        ...
        function v(t, e, n) {
          ...
          function o(t) {
            return null == t
              ...
              : t == +t
              ? t
              : (r(h, { height: t }), h.getBBox().height);
          }
          function s(i, r) {
            null == e
              ? (u[i] = r(t.attr(i)))
              : i == e && (u = r(null == n ? t.attr(i) : n));
          }
          var a = y(t),
            u = {},
          ...
          switch (
            (h ||
              ((h = r("rect")),
              r(h, { width: 10, height: 10, class: "svg---mgr" }),
              a.appendChild(h)),
            t.type)
          ) {
            case "rect":
        ...
        function b(t) {
          ...
          if (
            ...
            this.add = x;
            for (var r in C.prototype)
              C.prototype[M](r) && (this[r] = C.prototype[r]);
          }
        }
        function w(t) {
        ...
        function C(t, e) {
          ...
          if (t && "svg" == t.tagName) {
            ...
            (n = new b(t)),
              ...
              i ||
                ((i = r("desc")),
                i.appendChild(A.doc.createTextNode("Created with Snap")),
            ...
            (n = E("svg", A.doc.body)),
              r(n.node, { height: e, version: 1.1, width: t, xmlns: st });
          return n;
        }
        function k(t) {
          return t
            ? t instanceof b || t instanceof S
              ? t
              : "svg" == t.tagName
              ? new C(t)
              : new b(t)
        ...
        function P(t, n) {
          function i(t, e) {
            for (var n = (e - h) / (t - c), i = c; t > i; i++)
              a[i].offset = +(+h + n * (i - c)).toFixed(2);
            (c = t), (h = e);
          }
          var o,
            s = w(e("snap.util.grad.parse", null, n));
          if (!s) return null;
          s.params.unshift(t),
            (o =
            ...
            s.type != s.type.toLowerCase() &&
              r(o.node, { gradientUnits: "userSpaceOnUse" });
          var a = s.stops,
            u = a.length,
            h = 0,
            c = 0;
          ...
          for (
            a[u].offset = a[u].offset || 100, i(u, a[u].offset), l = 0;
            u >= l;
            l++
          ) {
            var f = a[l];
        ...
        function R(t, e, n, i, o) {
          ...
          return (
            ...
            (s.addStop = _),
            (s.getBBox = L),
            null != e && r(s.node, { x1: e, y1: n, x2: i, y2: o }),
            s
          );
        }
        function I(t, e, n, i, o, s) {
          ...
          return (
            ...
            (a.addStop = _),
            (a.getBBox = L),
            null != e && r(a.node, { cx: e, cy: n, r: i }),
            null != o && null != s && r(a.node, { fx: o, fy: s }),
            a
          );
        }
        function B(t) {
          return function (n) {
            if (
              ...
              n instanceof S &&
                ...
                ((n = n.node.firstChild), y(this).appendChild(n), (n = k(n))),
              n instanceof b)
            )
              if (
                "radialGradient" == n.type ||
                "linearGradient" == n.type ||
                "pattern" == n.type
              ) {
              ...
              var s = P(y(this), n);
              s
                ? (s.node.id || r(s.node, { id: s.id }), (o = ut(s.node.id)))
                : (o = n);
            } else o = j(o);
            var a = {};
        ...
        (i._.clone = s),
            ...
            (t.add = function (t, e, n, i, r, o) {
              ...
              (t.rotate = function (t, e, n) {
                ...
                var i = +N.cos(t).toFixed(9),
                  r = +N.sin(t).toFixed(9);
                return (
                  this.add(i, r, -r, i, e, n), this.add(1, 0, 0, 1, -e, -n)
                );
              }),
              (t.x = function (t, e) {
          ...
          (i.getRGB = u(function (t) {
            ...
            if ("none" == t)
              return { r: -1, g: -1, b: -1, hex: "none", toString: pt };
            if (
              (!(J[M](t.toLowerCase().substring(0, 2)) || "#" == t.charAt()) &&
                (t = ct(t)),
              !t)
            )
              return {
            ...
            return h
              ? (h[2] &&
                  ((r = D(h[2].substring(5), 16)),
                  (n = D(h[2].substring(3, 5), 16)),
                  (e = D(h[2].substring(1, 3), 16))),
                h[3] &&
                  ((r = D((a = h[3].charAt(3)) + a, 16)),
                  (n = D((a = h[3].charAt(2)) + a, 16)),
                  (e = D((a = h[3].charAt(1)) + a, 16))),
                h[4] &&
                  ((u = h[4].split(Z)),
                  (e = O(u[0])),
                  "%" == u[0].slice(-1) && (e *= 2.55),
                  ...
                  (r = O(u[2])),
                  "%" == u[2].slice(-1) && (r *= 2.55),
                  "rgba" == h[1].toLowerCase().slice(0, 4) && (s = O(u[3])),
                ...
                h[5]
                  ? ((u = h[5].split(Z)),
                    ...
                    ("deg" == u[0].slice(-3) || "Â°" == u[0].slice(-1)) &&
                      (e /= 360),
                    "hsba" == h[1].toLowerCase().slice(0, 4) && (s = O(u[3])),
                    u[3] && "%" == u[3].slice(-1) && (s /= 100),
                    i.hsb2rgb(e, n, r, s))
                  : h[6]
                  ? ((u = h[6].split(Z)),
                    ...
                    ("deg" == u[0].slice(-3) || "Â°" == u[0].slice(-1)) &&
                      (e /= 360),
                    "hsla" == h[1].toLowerCase().slice(0, 4) && (s = O(u[3])),
                    u[3] && "%" == u[3].slice(-1) && (s /= 100),
                    i.hsl2rgb(e, n, r, s))
                  : ((e = q(N.round(e), 255)),
                    (n = q(N.round(n), 255)),
                    (r = q(N.round(r), 255)),
                    (s = q(F(s, 0), 1)),
                    (h = { r: e, g: n, b: r, toString: pt }),
                    (h.hex =
                      "#" +
                      (16777216 | r | (n << 8) | (e << 16))
                        .toString(16)
                        .slice(1)),
                    (h.opacity = o(s, "finite") ? s : 1),
                    h))
              : { r: -1, g: -1, b: -1, hex: "none", error: 1, toString: pt };
          }, i)),
                ...
                j(t).replace(K, function (t, e, i) {
                  ...
                  if (
                    ...
                    for (
                      ;
                      o.length >= n[s] &&
                      (r.push([e].concat(o.splice(0, n[s]))), n[s]);
        ...
        (i._.svgTransform2string = p),
          ...
          (i._unit2px = v);
        var yt =
          A.doc.contains || A.doc.compareDocumentPosition
            ? function (t, e) {
        ...
        (i._.getSomeDefs = y),
          ...
          (i.selectAll = function (t) {
            for (
              var e = A.doc.querySelectorAll(t), n = (i.set || Array)(), r = 0;
              r < e.length;
              r++
            )
              n.push(k(e[r]));
          ...
          (function (t) {
            ...
            (t.attr = function (t, n) {
              ...
              if (o(t, "string")) {
                if (!(arguments.length > 1))
                  return w(e("snap.util.getattr." + t, i));
                var r = {};
                (r[t] = n), (t = r);
              }
              ...
              (t.getBBox = function (t) {
                ...
                var n = e._;
                return t
                  ? ((n.bboxwt = i.path.get[e.type]
                      ? i.path.getBBox((e.realPath = i.path.get[e.type](e)))
                      : i._.box(e.node.getBBox())),
                    i._.box(n.bboxwt))
                  : ((e.realPath = (i.path.get[e.type] || i.path.get.deflt)(e)),
                    (n.bbox = i.path.getBBox(i.path.map(e.realPath, e.matrix))),
                    i._.box(n.bbox));
              });
            var h = function () {
              return this.string;
            ...
            (t.transform = function (t) {
              ...
              return (
                t instanceof f && (t = t.toTransformString()),
                m(this, t),
                this.node &&
                  ("linearGradient" == this.type ||
                  "radialGradient" == this.type
                    ? r(this.node, { gradientTransform: this.matrix })
                    : "pattern" == this.type
                    ? r(this.node, { patternTransform: this.matrix })
                    : r(this.node, { transform: this.matrix })),
                this
              );
            }),
              (t.parent = function () {
              ...
              (t.use = function () {
                var t,
                  e = this.node.id;
                return (
                  e || ((e = this.id), r(this.node, { id: e })),
                  (t =
                    "linearGradient" == this.type ||
                    "radialGradient" == this.type ||
                    "pattern" == this.type
                      ? E(this.type, this.node.parentNode)
                      : E("use", this.node.parentNode)),
                  r(t.node, { "xlink:href": "#" + e }),
                  (t.original = this),
                  t
                );
              }),
            ...
            (i.animation = function (t, e, n, i) {
              ...
              (t.animate = function (t, i, r, s) {
                ...
                return (
                  ...
                  (b._attrs = t),
                  (b._callback = s),
                  e.once("mina.finish." + b.id, function () {
            ...
            (t.el = function (t, e) {
              ...
              (t.ellipse = function (t, e, n, i) {
                ...
                return (
                  o(t, "object") && "cx" in t
                    ? r.attr(t)
                    : null != t && r.attr({ cx: t, cy: e, rx: n, ry: i }),
                  r
                );
              }),
              (t.path = function (t) {
              ...
              (t.group = t.g = function (e) {
                ...
                return (
                  1 == arguments.length && e && !e.type
                    ? n.attr(e)
                    : arguments.length &&
                      n.add(Array.prototype.slice.call(arguments, 0)),
                  n
                );
              }),
              ...
              (t.line = function (t, e, n, i) {
                ...
                return (
                  o(t, "object")
                    ? r.attr(t)
                    : null != t && r.attr({ x1: t, x2: n, y1: e, y2: i }),
                  r
                );
              }),
            ...
            if (s) {
              if (o(n, "function")) (r = i), (i = n), (n = null);
                ...
                for (var h in n)
                  n.hasOwnProperty(h) &&
                    u.push(
                      encodeURIComponent(h) + "=" + encodeURIComponent(n[h])
                    );
                n = u.join("&");
              }
              return (
            ...
            if (t instanceof b || t instanceof S) {
              if (
                ...
                t instanceof S &&
                  ...
                  ((t = t.node.firstChild), y(this).appendChild(t), (t = k(t))),
                "mask" == t.type)
              )
                var n = t;
              else
        ...
        e.on("snap.util.grad.parse", function (t) {
          ...
          e.on("snap.util.attr.#text", function (t) {
            e.stop(), (t = j(t));
            for (var n = A.doc.createTextNode(t); this.node.firstChild; )
          ...
          e.on("snap.util.attr.textpath", function (t) {
            if ((e.stop(), "text" == this.type)) {
              ...
              if (o(t, "string")) {
                ...
                (t = k(t)),
                  t instanceof b &&
                    ((n = t.attr("id")), n || ((n = t.id), t.attr({ id: n })));
              if (n)
                if (((i = this.textPath), (s = this.node), i))
                  i.attr({ "xlink:href": "#" + n });
                else {
                  for (
                    i = r("textPath", { "xlink:href": "#" + n });
                    s.firstChild;
        ...
        e.on("snap.util.attr", function (t) {
          ...
          e.on("snap.util.getattr.r", function () {
            return "rect" == this.type &&
              r(this.node, "rx") == r(this.node, "ry")
              ? (e.stop(), r(this.node, "rx"))
              : void 0;
          })(-1),
        ...
        var bt = function (t) {
          var e = t.getBoundingClientRect(),
            ...
            u =
              e.left + (g.win.pageXOffset || r.scrollLeft || i.scrollLeft) - s;
          return { y: a, x: u };
        };
        return (
      ...
      i.plugin(function (t, e) {
        function n(t) {
          ...
          return (
            ...
            setTimeout(function () {
              for (var n in e)
                e[O](n) && n != t && (e[n].sleep--, !e[n].sleep && delete e[n]);
            }),
            e[t]
          );
        }
        ...
        function s(t, e, n, i, r, o, s, a, h) {
          return null == h
            ? p(t, e, n, i, r, o, s, a)
            : u(t, e, n, i, r, o, s, a, d(t, e, n, i, r, o, s, a, h));
        }
        function a(n, i) {
          function r(t) {
            return +(+t).toFixed(3);
          ...
          return t._.cacher(
            function (t, o, a) {
              ...
              for (
                var h, c, l, f, p, d = "", g = {}, m = 0, y = 0, v = t.length;
                v > y;
                y++
              ) {
                if (((l = t[y]), "M" == l[0])) (h = +l[1]), (c = +l[2]);
                  ...
                  if (
                    ((f = s(h, c, l[1], l[2], l[3], l[4], l[5], l[6])),
                    m + f > o)
                  ) {
                    if (i && !g.start) {
                      if (
              ...
              return (
                ...
                (p = n
                  ...
                  : i
                  ? g
                  : u(h, c, l[0], l[1], l[2], l[3], l[4], l[5], 1))
              );
            },
            null,
            t._.clone
        ...
        function d(t, e, n, i, r, o, s, a, u) {
          if (!(0 > u || p(t, e, n, i, r, o, s, a) < u)) {
            var h,
              ...
              f = c - l,
              d = 0.01;
            for (h = p(t, e, n, i, r, o, s, a, f); G(h - u) > d; )
              (l /= 2),
                (f += (u > h ? 1 : -1) * l),
        ...
        function m(t, e, n) {
          ...
          for (v = 0; c + 1 > v; v++)
            (x = u.apply(0, e.concat(v / c))),
              d.push({ x: x.x, y: x.y, t: v / c });
          for (v = 0; a > v; v++)
            for (var b = 0; c > b; b++) {
              var w = f[v],
                S = f[v + 1],
                E = d[b],
                C = d[b + 1],
                k = G(S.x - w.x) < 0.001 ? "y" : "x",
                T = G(C.x - E.x) < 0.001 ? "y" : "x",
              ...
              if (_) {
                ...
                L >= 0 &&
                  ...
                  P >= 0 &&
                  1 >= P &&
                  (n ? y++ : y.push({ x: _.x, y: _.y, t1: L, t2: P }));
              }
            }
          return y;
        }
        ...
        function x(t, e, n) {
          ...
          for (
            ...
            if ("M" == y[0]) (i = a = y[1]), (r = u = y[2]);
              ...
              "C" == y[0]
                ? ((l = [i, r].concat(y.slice(1))), (i = l[6]), (r = l[7]))
                : ((l = [i, r, i, r, a, u, a, u]), (i = a), (r = u));
              for (var v = 0, x = e.length; x > v; v++) {
                var b = e[v];
                if ("M" == b[0]) (o = h = b[1]), (s = c = b[2]);
                else {
                  "C" == b[0]
                    ? ((f = [o, s].concat(b.slice(1))), (o = f[6]), (s = f[7]))
                    : ((f = [o, s, o, s, h, c, h, c]), (o = h), (s = c));
                  var w = m(l, f, n);
                  if (n) p += w;
                  else {
                    for (var S = 0, E = w.length; E > S; S++)
                      (w[S].segment1 = d),
                        (w[S].segment2 = v),
                        (w[S].bez1 = l),
                        (w[S].bez2 = f);
        ...
        function w(t) {
          ...
          t = I(t);
          for (
            var r, o = 0, s = 0, a = [], u = [], h = 0, c = t.length;
            c > h;
            h++
          )
            if (((r = t[h]), "M" == r[0]))
              (o = r[1]), (s = r[2]), a.push(o), u.push(s);
            else {
            ...
            if (m[0] != s.call(m[0]))
              switch (((g[0] = s.call(m[0])), g[0])) {
                ...
                case "m":
                  (c = m[1]), (l = m[2]);
                default:
                  for (var y = 1, v = m.length; v > y; y++)
                    g[y] = +(m[y] - (y % 2 ? u : h)).toFixed(3);
              }
            else {
        ...
        function k(e) {
          ...
          for (
            ...
            if (
              (a.push((p = [])), (d = e[m]), (s = d[0]), s != s.toUpperCase())
            )
              switch (((p[0] = s.toUpperCase()), p[0])) {
                ...
                case "R":
                  for (
                    var v = [u, h].concat(d.slice(1)), x = 2, b = v.length;
                    b > x;
                    x++
                  )
                    (v[x] = +v[x] + u), (v[++x] = +v[x] + h);
                ...
                case "M":
                  (c = +d[1] + u), (l = +d[2] + h);
                default:
                  for (x = 1, b = d.length; b > x; x++)
                    p[x] = +d[x] + (x % 2 ? u : h);
              }
            else if ("R" == s)
              (v = [u, h].concat(d.slice(1))),
                a.pop(),
                (a = a.concat(z(v, g))),
              ...
              a.pop(),
                (a = a.concat(E(u, h, d[1], d[2], d[3]))),
                (p = ["U"].concat(a[a.length - 1].slice(-2)));
            else for (var w = 0, S = d.length; S > w; w++) p[w] = d[w];
        ...
        function L(e, n, i, r, o, s, a, u, h, c) {
          ...
          if (((N[0] = 2 * D[0] - N[0]), (N[1] = 2 * D[1] - N[1]), c))
            return [N, W, H].concat(d);
          d = [N, W, H].concat(d).join().split(",");
          for (var $ = [], V = 0, U = d.length; U > V; V++)
            $[V] = V % 2 ? g(d[V - 1], d[V], p).y : g(d[V], d[V + 1], p).x;
          return $;
        }
        function P(t, e, n, i, r, o, s, a, u) {
          var h = 1 - u;
        ...
        function R(t, e, n, i, r, o, s, a) {
          ...
          return (
            ...
            f > 0 &&
              1 > f &&
              ((u = P(t, e, n, i, r, o, s, a, f)), g.push(u.x), d.push(u.y)),
            p > 0 &&
              1 > p &&
              ((u = P(t, e, n, i, r, o, s, a, p)), g.push(u.x), d.push(u.y)),
            (h = o - 2 * i + e - (a - 2 * o + i)),
            (c = 2 * (i - e) - 2 * (o - i)),
            (l = e - i),
            (f = (-c + F.sqrt(c * c - 4 * h * l)) / 2 / h),
            ...
            p > 0 &&
              ...
              ((u = P(t, e, n, i, r, o, s, a, p)), g.push(u.x), d.push(u.y)),
            {
              min: { x: W.apply(0, g), y: W.apply(0, d) },
        ...
        function B(t, e) {
          ...
          for (t = I(t), r = 0, s = t.length; s > r; r++)
            for (u = t[r], o = 1, a = u.length; a > o; o += 2)
              (n = e.x(u[o], u[o + 1])),
                (i = e.y(u[o], u[o + 1])),
                (u[o] = n),
                (u[o + 1] = i);
        ...
        var A = e.prototype,
          ...
          Q = {
            ...
            line: function (t) {
              return (
                "M" + [t.attr("x1"), t.attr("y1"), t.attr("x2"), t.attr("y2")]
              );
            },
            polyline: function (t) {
      ...
      i.plugin(function (t) {
        ...
        (r.push = function () {
          ...
          (r.splice = function (t, r) {
            ...
            var h = u.length;
            for (o = 0; o < h + s.length; o++)
              this.items[t + o] = this[t + o] = h > o ? u[o] : s[o - h];
            for (o = this.items.length = this.length -= r - h; this[o]; )
              delete this[o++];
            return new i(a);
          }),
          ...
          (r.getBBox = function () {
            for (
              var t = [], i = [], r = [], o = [], s = this.items.length;
              s--;
      ...
      i.plugin(function (t, e) {
        ...
        function i(e, i, r) {
          ...
          for (
            ...
            if (
              ...
              (c = i[g] || n(h)),
              h[0] != c[0] ||
                ("r" == h[0].toLowerCase() && (h[2] != c[2] || h[3] != c[3])) ||
                ("s" == h[0].toLowerCase() && (h[3] != c[3] || h[4] != c[4])))
            ) {
            ...
            for (
              p[g] = [], d[g] = [], o = 0, s = Math.max(h.length, c.length);
              s > o;
              o++
            )
              o in h && (p[g][o] = h[o]), o in c && (d[g][o] = c[o]);
          }
        ...
        (h.stroke = h.fill = "colour"),
          (e.prototype.equal = function (e, n) {
            ...
            if ("d" == e || "path" == e)
              return (
                (f = t.path.toCubic(d, n)),
                { from: u(f[0]), to: u(f[1]), f: a(f[0]) }
              );
            if ("points" == e)
              return (
                (f = l(d).split(",")),
            ...
            var m = d.match(c),
              y = l(n).match(c);
            return m && m == y
              ? { from: parseFloat(d), to: parseFloat(n), f: o(m) }
              : { from: this.asPX(e), to: this.asPX(e, n), f: r };
          });
      }),
                    ...
                    var r = a && h[e] ? h[e] : e,
                      o = function (r) {
                        ...
                        if (a && h[s](e))
                          for (
                            var l = 0,
                              p = r.targetTouches && r.targetTouches.length;
                            p > l;
                            l++
                          )
                            if (
                              r.targetTouches[l].target == t ||
                              t.contains(r.targetTouches[l].target)
                            ) {
                              var g = r;
                              (r = r.targetTouches[l]),
                                (r.originalEvent = g),
                ...
                ? function (t, e, n, i) {
                    var o = function (t) {
                      ...
                      var e = c("y"),
                        ...
                        a = t.clientY + e;
                      return (
                        (t.preventDefault = t.preventDefault || l),
              ...
              for (
                ...
                if (((i = m[h]), a)) {
                  for (var l, f = n.touches && n.touches.length; f--; )
                    if (
                      ((l = n.touches[f]),
                      l.identifier == i.el._drag.id ||
                        i.el.node.contains(l.target))
                    ) {
                      (r = l.clientX),
                        (o = l.clientY),
                        (n.originalEvent
        ...
        (o.drag = function (n, i, r, o, s, a) {
          function u(u, h, c) {
            (u.originalEvent || u).preventDefault(),
              ...
              m.push({ el: this, move_scope: o, start_scope: s, end_scope: a }),
      ...
      i.plugin(function (t, n, i) {
        ...
        (t.filter = {}),
          (r.filter = function (e) {
            ...
            return (
              a(u, { id: o, filterUnits: "userSpaceOnUse" }),
  ...
  (function (t, e) {
    ...
    (s.prototype = new e()),
      ...
      (s.prototype.check = function () {
        function t(t, r) {
          return (
            e.options.debug && l && c.log("confirm", t, r),
            e.progress(t),
            n++,
            n === i && e.complete(),
            !0
    ...
    function i(t) {
      function i(t) {
        if (
          ...
          for (
            var c = (r.isBorderBox = !(!h || !i[h] || "border-box" !== i[h])),
              l = 0,
              f = s.length;
            f > l;
            l++
  ...
  (function (t, e) {
    ...
    function r(t, e) {
      i(t);
      for (
        var n = t.parentNode.querySelectorAll(e), r = 0, o = n.length;
        o > r;
        r++
      )
        if (n[r] === t) return !0;
    ...
    function s(n, s, l, p, d, g) {
      ...
      return (
        ...
        (m.prototype._itemsOn = function (t, e, n) {
          ...
          for (
            var r = 0, o = t.length, s = this, a = 0, u = t.length;
            u > a;
            a++
          ) {
            var h = t[a];
...
var Sketch = (function () {
  ...
  function u(t) {
    ...
    function s(t) {
      for (A = 0; A < tt.length; A++)
        (O = tt[A]),
          i(O)
            ? I[(t ? "add" : "remove") + "EventListener"].call(I, O, L, !1)
            : e(O)
            ? (L = O)
            : (I = O);
    }
    function u() {
      R(_),
        ...
        t.running &&
          !V &&
          ((t.dt = (j = +new Date()) - t.now),
          (t.millis += t.dt),
          (t.now = j),
          n(t.update),
          t.autoclear && J && t.clear(),
          n(t.draw)),
        (V = ++V % t.interval);
    }
    function h() {
      (I = Z ? t.style : t.canvas),
        ...
        (G = t.height),
        t.fullscreen &&
          ((G = t.height = v.innerHeight), ($ = t.width = v.innerWidth)),
        t.retina &&
          J &&
          Q &&
          ((I.style.height = G + "px"),
    ...
    function f(t) {
      if ((t.preventDefault(), (D = a(t)), (D.originalEvent = t), D.touches))
        for (U.length = D.touches.length, A = 0; A < D.touches.length; A++)
          U[A] = l(D.touches[A], U[A]);
    ...
    function p(e) {
      for (
        e = f(e),
          W = (H = tt.indexOf((N = e.type))) - 1,
          t.dragging = /down|start/.test(N)
            ? !0
            : /up|end/.test(N)
            ? !1
            : t.dragging;
        ...
        i(tt[W]) ? n(t[tt[W--]], e) : i(tt[H]) ? n(t[tt[H++]], e) : (W = 0);
    }
    function g(e) {
      (F = e.keyCode),
        (q = "keyup" == e.type),
  ...
  for (
    var h,
      c,
      l = "E LN10 LN2 LOG2E LOG10E PI SQRT1_2 SQRT2 abs acos asin atan ceil cos exp floor log round sin sqrt tan atan2 pow max min".split(
        " "
      ),
      f = "__hasSketch",
      p = Math,
      ...
      S = {
        ...
        create: function (t) {
          return (
            ...
            (h = t.element =
              t.element || y.createElement(t.type === m ? "div" : "canvas")),
            (c = t.context =
              t.context ||
              (function () {
                switch (t.type) {
                  ...
                  case g:
                    return (
                      h.getContext("webgl", t) ||
                      h.getContext("experimental-webgl", t)
                    );
                  case m:
                    return (h.canvas = h);
                }
    ...
    (P = C[E[I] + "Request" + T]), (R = C[E[I] + "Cancel" + T]);
  return (
    (C[_] = P =
      P ||
      function (t) {
...
!(function (t, e) {
  ...
  $(function () {
    ...
    var c = function (n) {
      function h() {
        o.width() > a && $(window).scrollTop() > l
          ? !c.hasClass("l-top--fixed")
          : c.hasClass("l-top--fixed");
      }
      setTimeout(function () {
      ...
      var f = 300,
        p = mina.backout;
      if (
        ($("[data-path-hover]").each(function (t, e) {
          var n = $(e),
            i = Snap(n.find("svg")[0]),
            r = i.select("path"),
            ...
            Sketch.create({
              ...
              draw: function () {
                var t,
                  ...
                  k;
                for (
                  this.lineCap = this.lineJoin = "round", k = [], h = d = 0;
                  x >= d;
                  h = d += 1
                ) {
                  for (
                    t = this.particles[h],
                      random() < 0.08 && (t.charge = -t.charge),
                      c = g = E = h + 1;
                    x >= g;
                    c = g += 1
                  )
                    (e = this.particles[c]),
                      (r = e.x - t.x),
                      (o = e.y - t.y),
                      (i = sqrt((n = r * r + o * o + 0.1))),
                      (p = t.radius + e.radius),
                      i >= p &&
                        ((l = 1 / i),
                        (a = r * l),
                        (u = o * l),
                        (s = min(v, (y * t.mass * e.mass) / n)),
                        (t.fx += s * a * e.charge),
                        (t.fy += s * u * e.charge),
                        (e.fx += -s * a * t.charge),
                        (e.fy += -s * u * t.charge));
                  for (
                    t.vx += t.fx,
                      ...
                      t.tail.length > w && t.tail.pop(),
                      t.x += t.vx,
                      t.y += t.vy,
                      t.fx = t.fy = 0,
                      t.x > this.width + t.radius
                        ? ((t.x = -t.radius), (t.tail = []))
                        : t.x < -t.radius &&
                          ((t.x = this.width + t.radius), (t.tail = [])),
                      t.y > this.height + t.radius
                        ? ((t.y = -t.radius), (t.tail = []))
                        : t.y < -t.radius &&
                          ((t.y = this.height + t.radius), (t.tail = [])),
                      this.strokeStyle = t.color,
                      this.lineWidth = 2 * t.radius,
                      this.beginPath(),
                      this.moveTo(t.x, t.y),
                      C = t.tail,
                      b = 0,
      ...
      (function () {
        ...
        function e() {
          var e = document.getElementById("bb-menu-wrapper"),
            ...
            a = function (t) {
              0 == $(t.target).parents(".bb-menu").length &&
                (i.removeClass("burger--open"),
                s(),
                setTimeout(function () {
          ...
          $.each(i, function (t, i) {
            $(".bb-menu").addClass(n),
              $(i).on(o, function (t) {
                return $(e).hasClass("bb-menu-open")
                  ? !0
                  : (r(),
                    setTimeout(function () {
                    ...
                    t.stopPropagation(),
                    t.preventDefault(),
                    (e.className = "bb-menu-wrapper"),
                    $(e).addClass(n),
                    setTimeout(function () {
                      $(e).addClass("bb-menu-open");
                    }, 0),
                    void $(document).on(o, a));
              });
          });
        }
        e();
